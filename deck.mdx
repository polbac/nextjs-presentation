...
<ul>
    <Appear>
        <li>my orders</li>
        <li>new upselling (coming soon)</li>
    </Appear>
</ul>
...
---
<img src="https://media.giphy.com/media/xT9IgusfDcqpPFzjdS/source.gif" width="200"/>

<div style='text-align:center;margin-top:40px;'>render your templete on server side on the first request<br/>and continue your application on the client.</div>
...
<ul>
    <Appear>
        ...
        <li>export options: ssr || static export</li>
        <li>custom server</li>
...
<img width="1100" src="https://i.ibb.co/jT7xf2W/Untitled-Diagram.jpg" />

---
### server side
<Codeblock code={`ReactDOMServer.renderToString(<App />)`} />


---
### client side
<Codeblock code={`ReactDOM.render(<App />, document.getElementById('app'))`} />
